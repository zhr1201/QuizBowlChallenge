...
class BM25BoWRetriever(AbsRetriever):
	...
	def train(self, path: str) -> None:
		...
		with open(path, 'rb') as f:
			...
			self.dictionary = params['dictionary']
		self.eval()
		return
		"""
	...
	def eval(self):
		...
		with open("guesses_test_BoW", 'wb') as f:
	...
	@classmethod
	def load(cls, path: str, k: int) -> 'BM25BoWRetriever':
		'''
		Args:
